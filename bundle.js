...
var Vingador = /*#__PURE__*/function (_Pessoa) {
  ...
  _createClass(Vingador, [{
    ...
    value: function lutar() {
      alert("".concat(this.nome, " que tem altura de ").concat(this.altura, "m, peso de ").concat(this.peso, " est\xE1 lutando utilizando ").concat(this.poderes[1]));
    }
  }]);
...
var sum = operacoesMatematicas.soma(4, 7);
alert(sum);
